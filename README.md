...
<p align="center">
  ...
  <a href="https://github.com/ntkdevelops">
...
**Languages** `C` `C++` `Java` `Python` `JavaScript` `Assembly (x86/x64)`
...
**Systems & Low Level Programming** `Windows API` `Linux Kernel` `Memory Forensics`

**Cloud & DevOps** `Docker` `Kubernetes` `AWS` `CI/CD Pipelines`

**Machine Learning for Security** `TensorFlow` `Scikit-learn` `Anomaly Detection`
