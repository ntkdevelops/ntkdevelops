...
**Languages**  
`C` `C++` `Java` `Python` `JavaScript` `Assembly (x86/x64)`

**Security & Reverse Engineering**  
`IDA Pro` `Ghidra` `OllyDbg` `Wireshark` `Burp Suite` `Metasploit`

**Web Development & Security**  
`Node.js` `Express.js` `MongoDB` `SQL` `Web Application Firewalls`

**Systems & Low-Level Programming**  
`Windows API` `Linux Kernel` `Memory Forensics`
